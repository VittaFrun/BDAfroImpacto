...
const update_comentario_dto_1 = require("./update-comentario.dto");
...
let ComentarioController = class ComentarioController {
    ...
    create(createComentarioDto, user) {
        return this.comentarioService.create(createComentarioDto, user.id_usuario);
    }
    findAll(tipoEntidad, idEntidad, includeRespuestas) {
        return this.comentarioService.findAll(tipoEntidad, idEntidad, includeRespuestas !== 'false');
    }
    findOne(id) {
        return this.comentarioService.findOne(id);
    }
    update(id, updateComentarioDto, user) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_comentario_dto_1.CreateComentarioDto, user_entity_1.Usuario]),
    __metadata("design:returntype", void 0)
], ComentarioController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)('tipo')),
    __param(1, (0, common_1.Query)('entidad', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Query)('includeRespuestas')),
    __metadata("design:type", Function),
